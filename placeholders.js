...
module.exports = {
    ...
    hair_color_exotic: [
        "peach", "mustard",
        "rust", "sand", "burgundy", "rose", "cream",
        "maroon", "sky blue", "navy", "lime", "olive",
        "mint", "copper", "teal", "lavender", "plum",
        "coral", "gold", "silver", "magenta", "indigo",
        "violet", 
        "blue", "green", "pink", "purple", "orange",
        "turquoise", "cyan", "mint", "pearl", "denim",
        "orchid", "emerald", "ruby", "sapphire", "amethyst",
        "chartreuse", "aquamarine", "crimson", "fuchsia",
    ...
    emotion: [
        ...
        "excited", "nervous", "relaxed", "bored", "confused",
        "curious", "frustrated", "jealous", "content", "anxious",
        "determined", "embarrassed", "hopeful", "lonely", "proud",
        "amused", "ashamed", "awed", "bashful", "blissful",
        "cheerful", "disgusted", "envious", "grateful", "guilty",
        "horrified", "indifferent", "irritated", "jovial", "melancholy",
        "optimistic", "pessimistic", "relieved", "shocked", "smug",
        "thoughtful", "touched", "troubled", "uncomfortable", "vindicated"
    ],

    // female given names
    femaleName: [
        "Mille", "Kelly", "Anna", "Emma", "Olivia",
        "Sophia", "Isabella", "Ava", "Mia", "Charlotte",
        "Amelia", "Harper", "Evelyn", "Abigail", "Emily",
        "Ella", "Madison", "Scarlett", "Victoria", "Aria",
        "Luna", "Grace", "Chloe", "Camila", "Penelope",
        "Riley", "Layla", "Lillian", "Nora", "Zoey",
        "Mila", "Aubrey", "Hannah", "Lily", "Addison",
        "Eleanor", "Natalie", "Savannah", "Brooklyn",
        "Leah", "Zoe", "Stella", "Hazel", "Ellie",
        "Paisley", "Audrey", "Skylar", "Violet", "Claire"
    ],

    // male given names
    maleName: [
        "Tom", "Fred", "Ben", "Liam", "Noah",
        "Oliver", "Elijah", "William", "James", "Benjamin",
        "Lucas", "Henry", "Alexander", "Mason", "Michael",
        "Ethan", "Daniel", "Matthew", "Aiden", "Joseph",
        "Samuel", "David", "Carter", "Wyatt", "Jack",
        "Owen", "Dylan", "Luke", "Gabriel", "Anthony",
        "Isaac", "Grayson", "Jayden", "Andrew", "Christopher",
        "Joshua", "Jaxon", "Lincoln", "Isaiah", "Adam",
        "Nathan", "Caleb", "Ryan", "Adrian", "Christian",
        "Maverick", "Colton", "Jordan", "Brayden", "John"
    ],
    ...
    ethnicity: [
        "Australian", "English", "Scottish", "US American", 
        "Canadian", "Irish", "Welsh", 
        "Chinese", "Japanese", "Korean", "Vietnamese",
        "Indian", "Pakistani", "Bangladeshi", "Sri Lankan",
        "German", "French", "Italian", "Spanish",
        "Mexican", "Brazilian", "Argentinian", "Chilean",
        "Filipino", "Thai", "Indonesian", "Malaysian",
        "Turkish", "Greek", "Russian", "Ukrainian",
        "Polish", "Dutch", "Swedish", "Norwegian", "Danish",
        "Finnish", "Swiss", "Austrian", "Belgian",
        "Egyptian", "Moroccan", "Nigerian", "Ethiopian",
        "South African", "Kenyan", "Tanzanian", "Ugandan",
        "Saudi Arabian", "Emirati", "Israeli", "Iranian",
        "Iraqi", "Syrian", "Jordanian", "Lebanese",
        "Afghan", "Burmese", "Cambodian", "Nepali",
        "Tibetan", "Mongolian", "Kazakh", "Uzbek", "Tajik",
        "Kyrgyz", "Turkmen", "Azerbaijani", "Georgian", "Armenian",
        "Haitian", "Cuban",
    ],
